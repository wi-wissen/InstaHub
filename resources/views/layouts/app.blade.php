        ...
        <nav class="navbar navbar-expand-md navbar-light sticky-top border-bottom">
            <div class="container">
                <a class="d-flex navbar-brand font-brand" href="{{ url('/') }}">
                    ...
                    {{ (RequestHub::isHub() && request()->getHost() == config('app.domain_admin')) ? config('app.name') : RequestHub::name() ?? config('app.name') }}
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        @guest
                            ...
                            @endif
                        @else
                            @if (RequestHub::hasTable('ads') && Auth::user()->allowed('dba') && RequestHub::isHub() && request()->getHost() !== config('app.domain_admin'))
