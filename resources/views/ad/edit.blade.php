        ...
        <div class="col-md-8">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>{{ __('Edit') }} <b x-text="name"></b></span>
                ...
                <div class="card-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ '/ads/' . $ad->id }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input x-model="name" id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $ad->name) }}" autofocus>
                                @error('name')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type">
                                    <option value="banner" {{ old('type', $ad->type) == 'banner' ? 'selected' : '' }}>{{ __('Banner') }}</option>
                                    <option value="photo" {{ old('type', $ad->type) == 'photo' ? 'selected' : '' }}>{{ __('Photo') }}</option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input id="priority" type="text" class="form-control @error('priority') is-invalid @enderror" name="priority" value="{{ old('priority', $ad->priority) }}" placeholder="1">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input x-model="url" id="url" type="text" class="form-control @error('url') is-invalid @enderror" name="url" value="{{ old('url', $ad->url) }}" placeholder="/noad">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input x-model="img" id="img" type="text" class="form-control @error('img') is-invalid @enderror" name="img" value="{{ old('img', $ad->img) }}" placeholder="/img/ad/sommerferien.jpg">
                        ...
                        <div class="row">
                            <div class="float-right">
                                <button x-bind:disabled="readonly" type="submit" class="btn btn-primary float-end">
                                    {{ __('Save') }}
                                </button>
                            </div>
                        </div>
