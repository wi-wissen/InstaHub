...
return [
    ...
    */
    ...
    'url_admin' => env('APP_URL_ADMIN', 'http://admin.localhost'),
    'url_hub' => env('APP_URL_HUB', 'http://{subdomain}.localhost'),
    ...
    |--------------------------------------------------------------------------
    |
    | This Domains are used to seperate Routing.
    |
    */
